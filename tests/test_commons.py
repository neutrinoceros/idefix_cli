...
def test_requires_idefix_undef(capsys, monkeypatch, subtests):
...
def test_requires_idefix_not_a_directory(capsys, monkeypatch, subtests, tmp_path):
...
def test_requires_idefix_def(capsys, monkeypatch, subtests, tmp_path):
    tmp_idefix_dir = str(tmp_path / "idefix")
